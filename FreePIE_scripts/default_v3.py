...
# - default_v3 - отличается от default_v1 тем что TAB теперь переключается между режимами кликабильности и мышеджоя
# - С теперь только включает обзор в обоих режимах
# =====================================================
# --- ВНИМАНИЕ !!! ---
...
# - C - удержание кнопки включает обзор
# - W, S - тяга
