...
# - saving_camera_v1.py - отличается от default_v1 тем что сохраняет вид камеры после смещения
# - так же дополнительно имеет клавишу F нормализации камеры по оси Х
# =====================================================
# --- ВНИМАНИЕ !!! ---
...
# - V - центрирование взгляда
# - F - Центрирует взгляд по оси X
# - C - включает мышеджой, удержание кнопку включает обзор
# - W, S - тяга
