...
# - saving_camera_v3 - отличается от saving_camera_v2 тем что TAB теперь нужно удерживать для обзора 
# - аналочно тому как в в default_v2
# =====================================================
# --- ВНИМАНИЕ !!! ---
...
if (
    ...
    or keyboard.getPressed(MOUSE_VJOY_TOGGLE_SAVE_VIEW_BUTTON))
):
    is_mouse_vjoy_unenable = False
    is_mouse_view_enabled = False
    is_mouse_vjoy_active = True
