...
"vJoy version of Driver (219) does NOT match DLL Version (218)", это значит что версия драйвера в FreePIE, не соответствует тому что в vJoy, исправляется путем копирования драйвера из x86 VJoy в FreePIE

Если не работает обзор 
- процерьте в monitor vjoy отрабатывается ли изменение осей
