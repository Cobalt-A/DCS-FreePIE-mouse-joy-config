...
это значит что версия драйвера в FreePIE, не соответствует тому что в vJoy, исправляется путем копирования драйвера из `C:\Program Files\vJoy\x86\vJoyInterface.dll` и заменой его в `C:\Program Files (x86)\FreePIE`

### OpenTrack не реагирует
